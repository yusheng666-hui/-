...
function makeStyles(theme: ThemeColors) {
  return StyleSheet.create({
    ...
    emptyTitle: { fontSize: 20, fontWeight: '600', color: theme.textMuted },
    emptyDesc: { fontSize: 14, color: theme.border, marginTop: 8, marginBottom: 20 },
    promptRow: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 10, paddingHorizontal: 8 },
    promptChip: { borderRadius: 16, paddingHorizontal: 16, paddingVertical: 10, borderWidth: 1 },
    promptChipText: { fontSize: 14 },
